...
if [ ! -f ".env.local" ]; then
    ...
    echo "Necesitarás:"
    echo "1. Configura tus variables de entorno en .env.local (ver .env.example)"
    echo "2. Reemplaza los valores con tus credenciales de Supabase"
...
echo ""
echo "Próximos pasos:"
echo "1. Editar .env.local con tus credenciales de Supabase"
echo "2. Verifica que tu proyecto Supabase esté listo"
...
echo "- Usa Supabase para desarrollo y producción"
echo ""
