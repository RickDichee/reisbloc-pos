...
│ Backend:     Firebase → Supabase (2026) │
│ Estado:      Zustand (minimal & fast)   │
│ Pagos:       MercadoPago API            │
│ Gráficas:    Chart.js                   │
│ Mobile:      PWA + Capacitor            │
│ Routing:     React Router v6            │
│ Hosting:     Vercel / Docker / On-prem  │
└─────────────────────────────────────────┘
```

**¿Por qué este stack?**
- ⚡ **Extremadamente rápido** → Iteramos features en días
- 🔓 **100% Open Source** → Ninguna licencia privada
- 📚 **Bien documentado** → Fácil de contribuir
- 🎯 **Battle-tested** → Usado en producción enterprise
- 🌍 **Comunidad activa** → Miles de recursos disponibles
